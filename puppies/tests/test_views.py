...
class GetAllPuppiesTest(TestCase):
    ...
    def test_valid_single_puppy(self):
...
class GetSinglePuppyTest(TestCase):
    '''
    Test module for getting single puppy API
    '''
...
class CreateNewPuppyTest(TestCase):
    '''
    Test module for creating a new Puppy
    ''' 
...
class UpdateSinglePuppyTest(TestCase):
    '''
    Test module for updating a single puppy record
    '''

    def setUp(self):
        self.casper = Puppy.objects.create(name='Casper', age=3, breed='Bull Dog', color='Black')
        self.muffin = Puppy.objects.create(name='Muffin', age=1, breed='Grandae', color='Brown')
        self.valid_payload = {
            'name': 'Muffy',
            'age': 2,
            'breed': 'Labrador',
    ...
    def test_valid_update_pupppy(self):
...
class DeletSinglePuppyTest(TestCase):
    '''
